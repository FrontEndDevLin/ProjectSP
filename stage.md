...
核心, 核心升级包, 道具均由(道具+武器组成)
伤害属性有时不需要显示, 通过增加配置来决定显示与否

左右开弓的实现修改(概率性), 不增加武器

被"散射"核心子弹命中的同个目标伤害减免
增加升级包"大号铅弹", 修改原核心属性(攻速, 穿透, 同个目标伤害), 修改全局修正属性(攻速加成)
增加升级包"弹幕时间"

"大号铅弹"变成另一种核心
"穿云"升级包实现

TODO: 增加属性"穿透"penetrate
角色属性"穿透伤害"
武器属性"穿透伤害", 2(-50% + 10%)
-50%为武器穿透伤害属性, 10%为角色属性穿透伤害
显示为:  贯穿: 2(-xx%伤害)
