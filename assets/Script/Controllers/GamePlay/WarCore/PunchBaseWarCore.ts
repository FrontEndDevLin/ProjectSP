 ...
 * 棱拳基础核心
 */
@ccclass('PunchBaseWarCore')
export class PunchBaseWarCore extends OBT_Component {
    // 警戒碰撞盒
    ...
    private _attack(dt: number): void {
        this._chooseTarget((hasAtkTarget: boolean, target: EMYInfo.RealTimeInfo) => {
            ...
            // 向量要根据贴图的旋转角度计算
            BulletManager.instance.createBulletByCHR({ bulletId: this.warCore.weaponCtx.bullet, position: chrLoc, vector });
