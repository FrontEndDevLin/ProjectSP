...
export namespace GamePlayEvent {
    ...
    export enum GAME_PALY {
        ...
        CORE_SELECT_TIMEOUT,
        CORE_SELECT_FINISH,
        CORE_UPGRADE_TIME_INIT,
        CORE_UPGRADE_DEAD_TIME,
        CORE_UPGRADE_TIME_REDUCE,
        CORE_UPGRADE_TIMEOUT,
        CORE_UPGRADE_FINISH,
        CHEST_OPEN_TIME_INIT,
        CHEST_OPEN_TIME_REDUCE,
        CHEST_OPEN_DEAD_TIME,
        CHEST_OPEN_TIMEOUT,
        CHEST_OPEN_FINISH,
        ATK_CORE_CHANGE,
        CORE_EXP_CHANGE,
